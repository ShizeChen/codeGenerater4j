...
public interface HiveParserVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitAlterMaterializedViewStatementSuffix(HiveParser.AlterMaterializedViewStatementSuffixContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitAlterStatementSuffixDropConstraint(HiveParser.AlterStatementSuffixDropConstraintContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitAlterStatementSuffixUpdateStatsCol(HiveParser.AlterStatementSuffixUpdateStatsColContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitAlterStatementSuffixAddPartitionsElement(HiveParser.AlterStatementSuffixAddPartitionsElementContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitAlterStatementSuffixDropPartitions(HiveParser.AlterStatementSuffixDropPartitionsContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitAlterMaterializedViewSuffixRewrite(HiveParser.AlterMaterializedViewSuffixRewriteContext ctx);
	/**
	 * Visit a parse tree produced by {@link HiveParser#alterMaterializedViewSuffixRebuild}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAlterMaterializedViewSuffixRebuild(HiveParser.AlterMaterializedViewSuffixRebuildContext ctx);
	/**
	 * Visit a parse tree produced by {@link HiveParser#alterStatementSuffixSerdeProperties}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAlterStatementSuffixSerdeProperties(HiveParser.AlterStatementSuffixSerdePropertiesContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitAlterStatementSuffixClusterbySortby(HiveParser.AlterStatementSuffixClusterbySortbyContext ctx);
	/**
	 * Visit a parse tree produced by {@link HiveParser#alterTblPartitionStatementSuffixSkewedLocation}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAlterTblPartitionStatementSuffixSkewedLocation(HiveParser.AlterTblPartitionStatementSuffixSkewedLocationContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitAlterStatementSuffixExchangePartition(HiveParser.AlterStatementSuffixExchangePartitionContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitPrecedenceSimilarExpressionPartNot(HiveParser.PrecedenceSimilarExpressionPartNotContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitSql11ReservedKeywordsUsedAsFunctionName(HiveParser.Sql11ReservedKeywordsUsedAsFunctionNameContext ctx);
	/**
